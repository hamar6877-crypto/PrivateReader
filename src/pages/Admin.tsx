...
export function Admin({ theme, onTheme }: { theme: string; onTheme: () => void }) {
  ...
  const isSuccess = status === 'کتێبەکە زیاد کرا' || status === 'کتێبەکە سڕایەوە';
